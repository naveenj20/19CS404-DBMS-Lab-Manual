...
## Question 1. Write a trigger to log every insertion into a table.
**Steps:**
...
## Question 2. Write a trigger to prevent deletion of records from a sensitive table.
**Steps:**
...
## Question 3. Write a trigger to automatically update a `last_modified` timestamp.
**Steps:**
...
## Question 5. Write a trigger that checks a condition before allowing insertion into a table.
**Steps:**
